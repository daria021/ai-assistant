...
def upgrade() -> None:
    ...
    sa.Enum('static', 'video', 'lottie', name='emoji_format').create(op.get_bind())
    # Drop the old default to avoid casting 'video'::format → emoji_format
...
def downgrade() -> None:
    ...
    sa.Enum('static', 'video', 'lottie', name='emoji_format').drop(op.get_bind())
    # ### end Alembic commands ###
